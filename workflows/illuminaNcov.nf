...
include {findVariantsInPrimerSites} from '../modules/illumina.nf'
...
workflow sequenceAnalysis {
    ...
    main:
      ...
      findVariantsInPrimerSites(callVariantsLofreq.out.variants.combine(articDownloadScheme.out.scheme))
